...
const CVSuggestionPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-50 py-10">
      <h2 className="text-3xl font-bold mb-8 text-gray-900">CV Presentation Suggestions</h2>
      <form onSubmit={handleGenerate} className="bg-white rounded-xl shadow border border-gray-200 max-w-xl w-full mb-6 p-6">
        <div className="mb-4">
      ...
      {draft && (
        <div className="bg-white rounded-xl shadow border border-gray-200 max-w-xl w-full p-6 mt-2">
