...
const Assistant: React.FC = () => {
  ...
  return (
    <>
      <div className="fixed bottom-6 mb-16 right-6 z-40 w-[350px] max-w-[95vw] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col animate-fadeIn">
        ...
        <div className="flex justify-center pb-3">
          <div className="rounded-full border border-gray-100 w-20 h-20 flex items-center justify-center mt-1">
            <img src={chatbotLogo} alt="ChatbotLogo" className="w-16 h-16 object-contain" />
          </div>
        </div>
      </div>
      <button
